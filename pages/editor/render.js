...
const Post=({ampUrl,stars,pp})=> (
    <>


        <ArticleTemplate date="Опубликовано сегодня" creator="Admin" title={pp} header="Разгадан смысл песни «Uno», которую Little Big записали для «Евровидения». Подсказка: загибайте пальцы — uno, dos, cuatro | FineBot" text={`
